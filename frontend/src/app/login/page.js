    ...
    <>
      ...
      <main className="login-shell" style={{ position: 'relative', overflow: 'hidden' }}>
        ...
        <section className="login-panel" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <a className="btn-primary login-google-button" href={getGoogleLoginUrl(nextPath)} aria-disabled={checking} style={{ borderRadius: '999px', padding: '0.75rem 2rem', fontSize: '0.95rem', display: 'inline-flex', alignItems: 'center', gap: '0.65rem' }}>
