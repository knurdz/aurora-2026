    ...
    <>
      ...
      <footer className="footer-wrap">
        <div className="footer-container">
          {/* Logo & Info */}
          <div>
            <h3 className="footer-logo" style={{ display: 'flex', alignItems: 'center', gap: '0.45rem' }}>
              <Logo size={38} />
          ...
          <div className="footer-col">
            ...
            <div className="footer-links">
              <Link href="/#capabilities">Claim Isolation</Link>
              <Link href="/#capabilities">Citation Cartels</Link>
              <Link href="/#capabilities">Statistical Audits</Link>
